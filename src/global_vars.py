...
EXPLAINER_GLOBAL = html.Span(
    [
        "The model (XGBoost) predicts the instance 121 of the training set as Non-ruptured with probability 0.618. The actual class is Ruptured which means that the model has",
        html.Span(" incorrectly ", style={"color": "red", "font-weight": "bold"}),
        "classified the instance!",
    ]
)
