"""
This module provides the structure, design and functionality
of RUSKLAINER web application
"""
                                ...
                                html.H6(
                                    ...
                                    children=html.Span(
                                        [
                                            ...
                                            "Identification of contributing features towards ",
                                            html.Span(
                                                        ...
                                                        [
                                                            dbc.CardBody(
                                                                [
                                                                    ...
                                                                    html.H6(
                                                                        id="select-sample-size",
                                                                        children="Select sample size",
                                                                    ),
                                                                    dcc.Slider(
                                                                        id="sample_slider",
                                                                        min=0,
                                                                ...
                                                                children=[
                                                                    ...
                                                                    dbc.Row(
                                                                        [
                                                                            ...
                                                                            html.Label(
                                                                                "Feature Effect: Coefficients of LIME explanations",
                                                                                style={
                                                                                    "textAlign": "center",
                                                                                    "fontFamily": "verdana",
                                                                                    "font-size": 14,
                                                    ...
                                                    dbc.Card(
                                                        dbc.CardBody(
                                                            ...
                                                            html.Div(
                                                                [
                                                                    html.H6(
                                                                        children="Black-box prediction probabilities"
                                                                    ),
                                                                    dcc.Loading(
                                                                        html.Div(
                                                                            dcc.Graph(
                                                                    ...
                                                                    html.Label(
                                                                        "Prediction Probability of Rupture status",
                                                                        style={
                                                                            "textAlign": "center",
                                                                            "fontFamily": "verdana",
                                                                            "font-size": 12,
                                                        ...
                                                        dbc.CardBody(
                                                            html.Div(
                                                                [
                                                                    html.H6(
                                                                        id="feature-label",
                                                                        children="Feature values of Instance {}".format(
                                                                            instance_global
                                                                        ),
                                                                    ),
                                                                    dcc.Loading(
                                        ...
                                        dbc.Col(
                                            html.Img(
                                                src="data:image/png;base64,{}".format(
                                                    encoded_tool_screenshot.decode()
                                                ),
                                                style={
                                                    "width": "100%",
                                                },
...
@app.callback(Output("model", "children"), [Input("model_dropdown", "value")])
def handle_dropdown_value(model_dropdown):
    return model_dropdown


# instance number input box callback
@app.callback(Output("instances", "children"), [Input("inp", "value")])
...
@app.callback(
    Output("sample size slider", "children"), [Input("sample_slider", "value")]
)
...
@app.callback(Output("my_text", "children"), [Input("model_dropdown", "value")])
...
def update_explainer_text(model_dropdown, inp, kw_dropdown, sample_slider):
    ...
    if inp is None or inp == 0:
        inp = 0
    text = plot_data.update_explainer_text(
        model_dropdown, kw_dropdown, sample_slider, inp
    )
    if " correctly" in text:
        ...
        return html.Span(
            [
                text1,
                html.Span(
                    " correctly ", style={"color": "green", "fontWeight": "bold"}
                ),
                text2,
            ]
        )
        ...
        return html.Span(
            [
                text1,
                html.Span(
                    " incorrectly ", style={"color": "red", "fontWeight": "bold"}
                ),
                text2,
            ]
        )
...
def update_LIME_plot(model_dropdown, inp, kw_slider, sample_slider):
    ...
    LIME_fig = {
        "data": plot_data.data_for_chart1(
            model_dropdown, kw_slider, sample_slider, inp
        ),
        "layout": {
            # 'height': '50%',
            "margin": {"l": 180, "b": 20, "t": 30, "r": 30},
            "xaxis": {"range": [-0.25, 0.25]},
            "yaxis": dict(autorange="reversed"),
            "paper_bgcolor": "rgba(0,0,0,0)",
            "plot_bgcolor": "rgba(0,0,0,0)",
        },
    }
    return dcc.Graph(id="LIME", figure=LIME_fig)


def global_store(model_dropdown, kw_dropdown, sample_slider, inp):
    value_data = plot_data.data_for_chart2(
        model_dropdown, kw_dropdown, sample_slider, inp
    )
    return value_data
    ...
    pred_fig = generate_figure(
        ...
        inp,
        {
            "data": [
                go.Bar(
                    y=["Non-rup", "Rup"],
                    marker=dict(color=["#004c00", "#990000"]),
                    orientation="h",
                )
            ],
        },
...
@app.callback(Output("feature-label", "children"), [Input("inp", "value")])
def update_label(value):
    if value is not None:
        return f"Feature values of Instance {value}"
    else:
...
def update_table(model_dropdown, inp, kw_dropdown, sample_slider):
    ...
    if inp is None or inp == 0:
        inp = 0
    dataframe_for_feature_value_table = plot_data.data_for_table(
        model_dropdown, kw_dropdown, sample_slider, inp
    )
    ...
    return dash_table.DataTable(
        ...
        columns=[
            {"name": i, "id": i}
            for i in dataframe_for_feature_value_table.iloc[:, :2].columns
        ],
...
@app.callback(
    [
        Output("explanation_plot", "children"),
        Output("expl_plot", "selectedData"),
        Output("slider_updatemode", "value"),
        Output("LIME_div", "children"),
        Output("explainer text", "children"),
        Output("feature_table_div", "children"),
        Output("predprob_fig_div", "children"),
    ],
    [
        Input("expl_plot", "figure"),
        Input("expl_plot", "selectedData"),
...
def explanation_callback(fig, clicked_point, kw, model_dropdown, inp, sample_slider):
        ...
        shapes=[
            {
                ...
                "line": {"color": "#00cc96", "width": 2, "dash": "dashdot"},
            },
        ],
        paper_bgcolor="rgba(0,0,0,0)",
    ...
    return (
        dcc.Graph(id="expl_plot", figure=fig),
        clicked_point,
        kw,
        LIME_plot,
        explainer_text,
